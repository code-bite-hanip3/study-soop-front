...
// 모달 사용하는 곳 : onClose={() => setIsModalOpen(false)} 이게 props로 들어가야됨
//                className = {styles.클래스이름}으로 props 사용
//                스타일 적용 순서 떄문에 모달 사용하는 파일의 css 에서 커스텀 클래스 이름 앞에 div를 붙여야됨
  ...
  return (
    <>
      <div className={styles.wrapModal} onClick={onClose}>
        <div
          className={`${styles.mainModal} ${className ?? ''}`}
